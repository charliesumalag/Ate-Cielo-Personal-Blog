...
const HomeBlogContent = React.memo(({title, author, category, tags, date, description }) => {
  return (
   <div className='font-lora w-[70%]'>
          <h3 className='font-bold font-poppins leading-[1.55em] tracking-[0.4px] text-[18px]'>{title}</h3>
          <div className='flex items-center  gap-3  mt-4' >
            <h5 className='uppercase font-roboto font-bold text-[#333] text-[13px] leading-[16px] tracking-[0.6px]'>{author}</h5>
          ...
          <div className='mt-2'>
            <p className='text-[14px] leading-[1.45em] text-[#777] tracking-[0.1px] font-roboto'>{description}</p>
          </div>
